...
{
    /// <summary>
    /// This class represents a Dictionary of Parts/Part References within
    /// a Blueprint model. This extends a normal <see cref="Dictionary{TKey, TValue}"/>
    /// in order to apply additional interfaces for use within the Blueprint Model.
    /// </summary>
    public class PartDictionary : Dictionary<string, IPartDefOrRef>, IPart, ICanHaveTemporaryID, IHasRuntimeType
    {
        /// <summary>
        ...
        /// <summary>
        /// Copy constructor. Generates a deep copy of the specified <see cref="PartDictionary"/>.
        /// </summary>
        /// <param name="aToCopy">
        /// The object to copy.
        /// </param>
        public PartDictionary(PartDictionary aToCopy, bool aShallow = false)
            : this()
        {
            Name = aToCopy.Name;
            ...
            { 
                ...
                {
                    this[lElement.Key] = lElement.Value.createCopy();
                }
            }
        }
